...
Scenario: Register a new employee
	...
	When register an employee with Name "Malthe K. Reuber", e-mail "s203869@student.dtu.dk" and employee ID "mkr" 	
	Then the person is an registered employee of the system with ID "mkr"
	
Scenario: Register an employee with an already existing emste_ployee ID
	Given that the admin is logged in
